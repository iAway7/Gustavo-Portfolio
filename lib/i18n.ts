...
const en = {
  ...
  experience: {
    ...
    certsSummary: "certifications in UX research, UX writing, and information architecture · Platzi",
    viewAll: "View all",
...
const es: Dict = {
  ...
  experience: {
    ...
    certsSummary: "certificaciones en investigación UX, redacción UX y arquitectura de información · Platzi",
    viewAll: "Ver todas",
